...
class TauIDEmbedderElectronCleaned(object):
    """class to rerun the tau seq and acces trainings from the database"""
    availableDiscriminators = [
        "2017v1", "2017v2ElectronCleaned", "newDM2017v2", "dR0p32017v2", "2016v1", "newDM2016v1",
        "deepTau2017v1", "deepTau2017v2", "deepTau2017v2p1ElectronCleaned",
        "DPFTau_2016_v0", "DPFTau_2016_v1",
        "againstEle2018"
    ]

    def __init__(self, process, cms, debug = False,
                 updatedTauName = "slimmedTausElectronCleanedNewID",
                 toKeep =  ["deepTau2017v2p1ElectronCleaned"],
        ...
        super(TauIDEmbedderElectronCleaned, self).__init__()
        ...
        for discr in toKeep:
            if discr not in TauIDEmbedderElectronCleaned.availableDiscriminators:
                raise RuntimeError('TauIDEmbedderElectronCleaned: discriminator "{}" is not supported'.format(discr))
        self.toKeep = toKeep
    ...
    def runTauID(self):
        ...
        self.process.rerunMvaIsolationSequenceElectronCleaned = self.cms.Sequence()
        ...
        if "2017v1" in self.toKeep:
            ...
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v1raw = patDiscriminationByIsolationMVArun2v1raw.clone(
                PATTauProducer = self.cms.InputTag('slimmedTausElectronCleaned'),
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.cms.Sequence(self.rerunIsolationOldDMMVArun2017v1Task)
        ...
        if "2017v2ElectronCleaned" in self.toKeep:
            ...
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2rawElectronCleaned = patDiscriminationByIsolationMVArun2v1raw.clone(
                PATTauProducer = self.cms.InputTag('slimmedTausElectronCleaned'),
                Prediscriminants = noPrediscriminants,
                loadMVAfromDB = self.cms.bool(True),
            ...
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseElectronCleaned = patDiscriminationByIsolationMVArun2v1VLoose.clone(
                PATTauProducer = self.cms.InputTag('slimmedTausElectronCleaned'),
                Prediscriminants = noPrediscriminants,
                toMultiplex = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2rawElectronCleaned'),
                key = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2rawElectronCleaned:category'),#?
                loadMVAfromDB = self.cms.bool(True),
            ...
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVLooseElectronCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseElectronCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVLooseElectronCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff95")
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2LooseElectronCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseElectronCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2LooseElectronCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff80")
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2MediumElectronCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseElectronCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2MediumElectronCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff70")
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2TightElectronCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseElectronCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2TightElectronCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff60")
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VTightElectronCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseElectronCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VTightElectronCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff50")
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVTightElectronCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseElectronCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVTightElectronCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff40")

            self.rerunIsolationOldDMMVArun2017v2TaskElectronCleaned = self.cms.Task(
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2rawElectronCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseElectronCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVLooseElectronCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2LooseElectronCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2MediumElectronCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2TightElectronCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VTightElectronCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVTightElectronCleaned
            )
            self.process.rerunMvaIsolationTask.add(self.rerunIsolationOldDMMVArun2017v2TaskElectronCleaned)
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.cms.Sequence(self.rerunIsolationOldDMMVArun2017v2TaskElectronCleaned)

            tauIDSources.byIsolationMVArun2017v2DBoldDMwLTraw2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2rawElectronCleaned')
            tauIDSources.byVVLooseIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2VVLooseElectronCleaned')
            tauIDSources.byVLooseIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseElectronCleaned')
            tauIDSources.byLooseIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2LooseElectronCleaned')
            tauIDSources.byMediumIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2MediumElectronCleaned')
            tauIDSources.byTightIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2TightElectronCleaned')
            tauIDSources.byVTightIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2VTightElectronCleaned')
            tauIDSources.byVVTightIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2VVTightElectronCleaned')
        ...
        if "newDM2017v2" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.cms.Sequence(self.rerunIsolationNewDMMVArun2017v2Task)
        ...
        if "dR0p32017v2" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.cms.Sequence(self.rerunIsolationOldDMdR0p3MVArun2017v2Task)
        ...
        if "2016v1" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.cms.Sequence(self.rerunIsolationOldDMMVArun2016v1Task)
        ...
        if "newDM2016v1" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.cms.Sequence(self.rerunIsolationNewDMMVArun2016v1Task)
        ...
        if "deepTau2017v1" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.process.deepTau2017v1
        ...
        if "deepTau2017v2" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.process.deepTau2017v2

        if "deepTau2017v2p1ElectronCleaned" in self.toKeep:
            if self.debug: print "Adding DeepTau IDs"
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.process.ElectronClusterClean
            ...
            self.process.rerunMvaIsolationTask.add(self.process.deepTau2017v2p1ElectronCleaned)
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.process.deepTau2017v2p1ElectronCleaned
        ...
        if "DPFTau_2016_v0" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.process.dpfTau2016v0
        ...
        if "DPFTau_2016_v1" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.process.dpfTau2016v1
        ...
        if "againstEle2018" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceElectronCleaned += self.process.patTauDiscriminationByElectronRejectionMVA62018Seq
        ...
        if not hasattr(self.process, self.updatedTauName):
            embedID = self.cms.EDProducer("PATTauIDEmbedder",
               src = self.cms.InputTag('slimmedTausElectronCleaned'),
