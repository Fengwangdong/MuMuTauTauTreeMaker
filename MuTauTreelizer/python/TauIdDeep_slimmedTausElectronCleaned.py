...
class TauIDEmbedderElectronCleaned(object):
    ...
    def __init__(self, process, debug = False,
                 originalTauName = "slimmedTausElectronCleaned",
    ...
    def runTauID(self):
        _rerunMvaIsolationTaskElectronCleaned = cms.Task()
        _rerunMvaIsolationSequenceElectronCleaned = cms.Sequence()
        ...
        if "2017v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskElectronCleaned.add(_rerunIsolationOldDMMVArun2017v1Task)
            _rerunMvaIsolationSequenceElectronCleaned += cms.Sequence(_rerunIsolationOldDMMVArun2017v1Task)
        ...
        if "2017v2" in self.toKeep:
            ...
            _rerunMvaIsolationTaskElectronCleaned.add(_rerunIsolationOldDMMVArun2017v2Task)
            _rerunMvaIsolationSequenceElectronCleaned += cms.Sequence(_rerunIsolationOldDMMVArun2017v2Task)
        ...
        if "newDM2017v2" in self.toKeep:
            ...
            _rerunMvaIsolationTaskElectronCleaned.add(_rerunIsolationNewDMMVArun2017v2Task)
            _rerunMvaIsolationSequenceElectronCleaned += cms.Sequence(_rerunIsolationNewDMMVArun2017v2Task)
        ...
        if "dR0p32017v2" in self.toKeep:
            ...
            _rerunMvaIsolationTaskElectronCleaned.add(_rerunIsolationOldDMdR0p3MVArun2017v2Task)
            _rerunMvaIsolationSequenceElectronCleaned += cms.Sequence(_rerunIsolationOldDMdR0p3MVArun2017v2Task)
        ...
        if "2016v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskElectronCleaned.add(_rerunIsolationOldDMMVArun2016v1Task)
            _rerunMvaIsolationSequenceElectronCleaned += cms.Sequence(_rerunIsolationOldDMMVArun2016v1Task)
        ...
        if "newDM2016v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskElectronCleaned.add(_rerunIsolationNewDMMVArun2016v1Task)
            _rerunMvaIsolationSequenceElectronCleaned += cms.Sequence(_rerunIsolationNewDMMVArun2016v1Task)
        ...
        if "deepTau2017v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskElectronCleaned.add(_deepTauProducer)
            _rerunMvaIsolationSequenceElectronCleaned += _deepTauProducer
        ...
        if "deepTau2017v2p1" in self.toKeep:
            ...
            setattr(self.process,"ElectronClusterClean"+self.postfix,cms.EDProducer("ElectronClusterClean",
                    EleTag      = cms.InputTag("slimmedElectrons"),
                    TauTag      = cms.InputTag(self.originalTauName),
            ...
            _ElectronClusterClean = getattr(self.process,"ElectronClusterClean"+self.postfix)
            _rerunMvaIsolationTaskElectronCleaned.add(_ElectronClusterClean)
            _rerunMvaIsolationSequenceElectronCleaned += _ElectronClusterClean
        ...
        if "againstEle2018" in self.toKeep:
            ...
            _rerunMvaIsolationTaskElectronCleaned.add(_patTauDiscriminationByElectronRejectionMVA62018Task)
            _rerunMvaIsolationSequenceElectronCleaned += cms.Sequence(_patTauDiscriminationByElectronRejectionMVA62018Task)
        ...
        if "newDMPhase2v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskElectronCleaned.add(_rerunIsolationMVADBnewDMwLTPhase2Task)
            _rerunMvaIsolationSequenceElectronCleaned += cms.Sequence(_rerunIsolationMVADBnewDMwLTPhase2Task)
        ...
        if "againstElePhase2v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskElectronCleaned.add(_patTauDiscriminationByElectronRejectionMVA6Phase2v1Task)
            _rerunMvaIsolationSequenceElectronCleaned += cms.Sequence(_patTauDiscriminationByElectronRejectionMVA6Phase2v1Task)
        ...
        setattr(self.process,"rerunMvaIsolationTask"+self.postfix,_rerunMvaIsolationTaskElectronCleaned)
        setattr(self.process,"rerunMvaIsolationSequence"+self.postfix,_rerunMvaIsolationSequenceElectronCleaned)
