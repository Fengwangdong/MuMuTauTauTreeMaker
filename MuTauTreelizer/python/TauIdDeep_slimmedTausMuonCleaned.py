...
class TauIDEmbedderMuonCleaned(object):
    """class to rerun the tau seq and acces trainings from the database"""
    availableDiscriminators = [
        "2017v1", "2017v2MuonCleaned", "newDM2017v2", "dR0p32017v2", "2016v1", "newDM2016v1",
        "deepTau2017v1", "deepTau2017v2", "deepTau2017v2p1MuonCleaned",
        "DPFTau_2016_v0", "DPFTau_2016_v1",
        "againstEle2018"
    ]

    def __init__(self, process, cms, debug = False,
                 updatedTauName = "slimmedTausMuonCleanedNewID",
                 toKeep =  ["deepTau2017v2p1MuonCleaned"],
        ...
        super(TauIDEmbedderMuonCleaned, self).__init__()
        ...
        for discr in toKeep:
            if discr not in TauIDEmbedderMuonCleaned.availableDiscriminators:
                raise RuntimeError('TauIDEmbedderMuonCleaned: discriminator "{}" is not supported'.format(discr))
        self.toKeep = toKeep
    ...
    def runTauID(self):
        ...
        self.process.rerunMvaIsolationSequenceMuonCleaned = self.cms.Sequence()
        ...
        if "2017v1" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.cms.Sequence(self.rerunIsolationOldDMMVArun2017v1Task)
        ...
        if "2017v2MuonCleaned" in self.toKeep:
            ...
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2rawMuonCleaned = patDiscriminationByIsolationMVArun2v1raw.clone(
                PATTauProducer = self.cms.InputTag('slimmedTausMuonCleaned'),
                Prediscriminants = noPrediscriminants,
                loadMVAfromDB = self.cms.bool(True),
            ...
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseMuonCleaned = patDiscriminationByIsolationMVArun2v1VLoose.clone(
                PATTauProducer = self.cms.InputTag('slimmedTausMuonCleaned'),
                Prediscriminants = noPrediscriminants,
                toMultiplex = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2rawMuonCleaned'),
                key = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2rawMuonCleaned:category'),#?
                loadMVAfromDB = self.cms.bool(True),
            ...
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVLooseMuonCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseMuonCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVLooseMuonCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff95")
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2LooseMuonCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseMuonCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2LooseMuonCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff80")
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2MediumMuonCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseMuonCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2MediumMuonCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff70")
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2TightMuonCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseMuonCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2TightMuonCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff60")
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VTightMuonCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseMuonCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VTightMuonCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff50")
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVTightMuonCleaned = self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseMuonCleaned.clone()
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVTightMuonCleaned.mapping[0].cut = self.cms.string("RecoTauTag_tauIdMVAIsoDBoldDMwLT2017v2_WPEff40")

            self.rerunIsolationOldDMMVArun2017v2TaskMuonCleaned = self.cms.Task(
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2rawMuonCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseMuonCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVLooseMuonCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2LooseMuonCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2MediumMuonCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2TightMuonCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VTightMuonCleaned,
                self.process.rerunDiscriminationByIsolationOldDMMVArun2017v2VVTightMuonCleaned
            )
            self.process.rerunMvaIsolationTask.add(self.rerunIsolationOldDMMVArun2017v2TaskMuonCleaned)
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.cms.Sequence(self.rerunIsolationOldDMMVArun2017v2TaskMuonCleaned)

            tauIDSources.byIsolationMVArun2017v2DBoldDMwLTraw2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2rawMuonCleaned')
            tauIDSources.byVVLooseIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2VVLooseMuonCleaned')
            tauIDSources.byVLooseIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2VLooseMuonCleaned')
            tauIDSources.byLooseIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2LooseMuonCleaned')
            tauIDSources.byMediumIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2MediumMuonCleaned')
            tauIDSources.byTightIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2TightMuonCleaned')
            tauIDSources.byVTightIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2VTightMuonCleaned')
            tauIDSources.byVVTightIsolationMVArun2017v2DBoldDMwLT2017 = self.cms.InputTag('rerunDiscriminationByIsolationOldDMMVArun2017v2VVTightMuonCleaned')
        ...
        if "newDM2017v2" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.cms.Sequence(self.rerunIsolationNewDMMVArun2017v2Task)
        ...
        if "dR0p32017v2" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.cms.Sequence(self.rerunIsolationOldDMdR0p3MVArun2017v2Task)
        ...
        if "2016v1" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.cms.Sequence(self.rerunIsolationOldDMMVArun2016v1Task)
        ...
        if "newDM2016v1" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.cms.Sequence(self.rerunIsolationNewDMMVArun2016v1Task)
        ...
        if "deepTau2017v1" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.process.deepTau2017v1
        ...
        if "deepTau2017v2" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.process.deepTau2017v2

        if "deepTau2017v2p1MuonCleaned" in self.toKeep:
            if self.debug: print ("Adding DeepTau IDs")
            ...
            self.process.MuonClusterClean = self.cms.EDProducer("MuonClusterClean",
                    ...
                    TauTag  = self.cms.InputTag("slimmedTausMuonCleaned"),
                    ParticleFlowCandTag = self.cms.InputTag("packedPFCandidates"),
                    muonID  = self.cms.string('loose'),
                    ptCut   = self.cms.double(3.0),
            )

            self.process.rerunMvaIsolationTask.add(self.process.MuonClusterClean)
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.process.MuonClusterClean
            ...
            self.process.rerunMvaIsolationTask.add(self.process.deepTau2017v2p1MuonCleaned)
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.process.deepTau2017v2p1MuonCleaned
        ...
        if "DPFTau_2016_v0" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.process.dpfTau2016v0
        ...
        if "DPFTau_2016_v1" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.process.dpfTau2016v1
        ...
        if "againstEle2018" in self.toKeep:
            ...
            self.process.rerunMvaIsolationSequenceMuonCleaned += self.process.patTauDiscriminationByElectronRejectionMVA62018Seq
