...
class TauIDEmbedderMuonCleaned(object):
    ...
    def __init__(self, process, debug = False,
                 originalTauName = "slimmedTausMuonCleaned",
    ...
    def runTauID(self):
        _rerunMvaIsolationTaskMuonCleaned = cms.Task()
        _rerunMvaIsolationSequenceMuonCleaned = cms.Sequence()
        ...
        if "2017v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskMuonCleaned.add(_rerunIsolationOldDMMVArun2017v1Task)
            _rerunMvaIsolationSequenceMuonCleaned += cms.Sequence(_rerunIsolationOldDMMVArun2017v1Task)
        ...
        if "2017v2" in self.toKeep:
            ...
            _rerunMvaIsolationTaskMuonCleaned.add(_rerunIsolationOldDMMVArun2017v2Task)
            _rerunMvaIsolationSequenceMuonCleaned += cms.Sequence(_rerunIsolationOldDMMVArun2017v2Task)
        ...
        if "newDM2017v2" in self.toKeep:
            ...
            _rerunMvaIsolationTaskMuonCleaned.add(_rerunIsolationNewDMMVArun2017v2Task)
            _rerunMvaIsolationSequenceMuonCleaned += cms.Sequence(_rerunIsolationNewDMMVArun2017v2Task)
        ...
        if "dR0p32017v2" in self.toKeep:
            ...
            _rerunMvaIsolationTaskMuonCleaned.add(_rerunIsolationOldDMdR0p3MVArun2017v2Task)
            _rerunMvaIsolationSequenceMuonCleaned += cms.Sequence(_rerunIsolationOldDMdR0p3MVArun2017v2Task)
        ...
        if "2016v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskMuonCleaned.add(_rerunIsolationOldDMMVArun2016v1Task)
            _rerunMvaIsolationSequenceMuonCleaned += cms.Sequence(_rerunIsolationOldDMMVArun2016v1Task)
        ...
        if "newDM2016v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskMuonCleaned.add(_rerunIsolationNewDMMVArun2016v1Task)
            _rerunMvaIsolationSequenceMuonCleaned += cms.Sequence(_rerunIsolationNewDMMVArun2016v1Task)
        ...
        if "deepTau2017v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskMuonCleaned.add(_deepTauProducer)
            _rerunMvaIsolationSequenceMuonCleaned += _deepTauProducer
        ...
        if "deepTau2017v2p1" in self.toKeep:
            ...
            setattr(self.process,"MuonClusterClean"+self.postfix,cms.EDProducer("MuonClusterClean",
            ...
            _MuonClusterClean = getattr(self.process,"MuonClusterClean"+self.postfix)
            _rerunMvaIsolationTaskMuonCleaned.add(_MuonClusterClean)
            _rerunMvaIsolationSequenceMuonCleaned += _MuonClusterClean
        ...
        if "againstEle2018" in self.toKeep:
            ...
            _rerunMvaIsolationTaskMuonCleaned.add(_patTauDiscriminationByElectronRejectionMVA62018Task)
            _rerunMvaIsolationSequenceMuonCleaned += cms.Sequence(_patTauDiscriminationByElectronRejectionMVA62018Task)
        ...
        if "newDMPhase2v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskMuonCleaned.add(_rerunIsolationMVADBnewDMwLTPhase2Task)
            _rerunMvaIsolationSequenceMuonCleaned += cms.Sequence(_rerunIsolationMVADBnewDMwLTPhase2Task)
        ...
        if "againstElePhase2v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskMuonCleaned.add(_patTauDiscriminationByElectronRejectionMVA6Phase2v1Task)
            _rerunMvaIsolationSequenceMuonCleaned += cms.Sequence(_patTauDiscriminationByElectronRejectionMVA6Phase2v1Task)
        ...
        setattr(self.process,"rerunMvaIsolationTask"+self.postfix,_rerunMvaIsolationTaskMuonCleaned)
        setattr(self.process,"rerunMvaIsolationSequence"+self.postfix,_rerunMvaIsolationSequenceMuonCleaned)
