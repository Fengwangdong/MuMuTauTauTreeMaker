...
class TauIDEmbedderBoosted(object):
    ...
    def runTauID(self):
        _rerunMvaIsolationTaskBoosted = cms.Task()
        _rerunMvaIsolationSequenceBoosted = cms.Sequence()
        ...
        if "2017v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskBoosted.add(_rerunIsolationOldDMMVArun2017v1Task)
            _rerunMvaIsolationSequenceBoosted += cms.Sequence(_rerunIsolationOldDMMVArun2017v1Task)
        ...
        if "2017v2" in self.toKeep:
            ...
            _rerunMvaIsolationTaskBoosted.add(_rerunIsolationOldDMMVArun2017v2Task)
            _rerunMvaIsolationSequenceBoosted += cms.Sequence(_rerunIsolationOldDMMVArun2017v2Task)
        ...
        if "newDM2017v2" in self.toKeep:
            ...
            _rerunMvaIsolationTaskBoosted.add(_rerunIsolationNewDMMVArun2017v2Task)
            _rerunMvaIsolationSequenceBoosted += cms.Sequence(_rerunIsolationNewDMMVArun2017v2Task)
        ...
        if "dR0p32017v2" in self.toKeep:
            ...
            _rerunMvaIsolationTaskBoosted.add(_rerunIsolationOldDMdR0p3MVArun2017v2Task)
            _rerunMvaIsolationSequenceBoosted += cms.Sequence(_rerunIsolationOldDMdR0p3MVArun2017v2Task)
        ...
        if "2016v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskBoosted.add(_rerunIsolationOldDMMVArun2016v1Task)
            _rerunMvaIsolationSequenceBoosted += cms.Sequence(_rerunIsolationOldDMMVArun2016v1Task)
        ...
        if "newDM2016v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskBoosted.add(_rerunIsolationNewDMMVArun2016v1Task)
            _rerunMvaIsolationSequenceBoosted += cms.Sequence(_rerunIsolationNewDMMVArun2016v1Task)
        ...
        if "deepTau2017v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskBoosted.add(_deepTauProducer)
            _rerunMvaIsolationSequenceBoosted += _deepTauProducer
        ...
        if "againstEle2018" in self.toKeep:
            ...
            _rerunMvaIsolationTaskBoosted.add(_patTauDiscriminationByElectronRejectionMVA62018Task)
            _rerunMvaIsolationSequenceBoosted += cms.Sequence(_patTauDiscriminationByElectronRejectionMVA62018Task)
        ...
        if "newDMPhase2v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskBoosted.add(_rerunIsolationMVADBnewDMwLTPhase2Task)
            _rerunMvaIsolationSequenceBoosted += cms.Sequence(_rerunIsolationMVADBnewDMwLTPhase2Task)
        ...
        if "againstElePhase2v1" in self.toKeep:
            ...
            _rerunMvaIsolationTaskBoosted.add(_patTauDiscriminationByElectronRejectionMVA6Phase2v1Task)
            _rerunMvaIsolationSequenceBoosted += cms.Sequence(_patTauDiscriminationByElectronRejectionMVA6Phase2v1Task)
        ...
        setattr(self.process,"rerunMvaIsolationTask"+self.postfix,_rerunMvaIsolationTaskBoosted)
        setattr(self.process,"rerunMvaIsolationSequence"+self.postfix,_rerunMvaIsolationSequenceBoosted)
